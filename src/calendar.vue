<template>
    <div id="calendar">
        ...
        <!--<div class="v-picker v-card v-picker&#45;&#45;date mt-3 v-picker&#45;&#45;landscape theme&#45;&#45;light v-picker&#45;&#45;full-width">-->
            <!--<div class="v-picker__title v-picker__title&#45;&#45;landscape blue" style="color:white;padding: 0">dveve</div>-->
            <!--<div class="v-picker__body theme&#45;&#45;light">fsdsfefe</div>-->
        <!--</div>-->
        <v-data-table
                :headers="headers"
                :items="apartment"
            ...
            <template slot="items" slot-scope="props">
                <tr>
                    ...
                    <div style="display: flex;flex-wrap: wrap">
                        <td class="text-xs-right" style="flex: 1 1 auto;" v-for="tone in props.item.time">
...
//                  },
                  time(data,time, name) {
                      console.log(data,time, name)
                      let hour = Number(time.substr(0,2))
                      let dataClick = this.date.split('-')
                      let sentData = new Date(dataClick[0], dataClick[1], dataClick[2],hour)
                      let obj = {
