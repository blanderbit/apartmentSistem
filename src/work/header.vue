        ...
        <div class="page-container md-layout-column" :class="{activePage:showNavigation == true || showSidepanel == true?true:false}">
            ...
            <md-drawer class="md-right" :md-active.sync="showSidepanel">
                ...
                <md-list>
                    ...
                    <span v-if="token == true?true:false">ID:<span>{{idUser}}</span></span>
                    <md-button v-if="token == true?true:false" @click="logOut()">Log out</md-button>
                </md-list>
            </md-drawer>
        </div>
      ...
      methods:{
          ...
          open(){
              if(window.innerWidth < 900) {
                  let elem = event.currentTarget.children[0];
...
.window{
  ...
  transition: all 1s;
  padding: 10px;
  box-shadow: 1px 1px 1px 1px rgba(186, 186, 186,0.7);
}
.button{
    padding: 5px;
    margin: 10px 0;
  ...
  header{
      ...
      .logoByProfil{
          ...
          .profil{
              background-image: url('data:image/png;base64,');
              padding: 20px;
              position: relative;
              background-position: center;
